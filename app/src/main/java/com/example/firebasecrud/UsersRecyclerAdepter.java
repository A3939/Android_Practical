...
public class UsersRecyclerAdepter extends RecyclerView.Adapter<UsersRecyclerAdepter.ViewHolder> {

    Context context;
    ArrayList<UsersItem> usersItemArrayList;
    DatabaseReference databaseReference;

    public UsersRecyclerAdepter(Context context,ArrayList<UsersItem> usersItemArrayList) {
